...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{asset('assets-v2/img/core-img/favicon.ico')}}" />
...
<body>
<!-- Background Video-->
<video class="bg-video" playsinline="playsinline" autoplay="autoplay" muted="muted" loop="loop"><source src="{{asset('maintain/assets/mp4/bg.mp4')}}" type="video/mp4" /></video>
<!-- Masthead-->
<div class="masthead">
...
<!-- Core theme JS-->
<script src="{{asset('maintain/js/scripts.js')}}"></script>
<!-- * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *-->
<!-- * *                               SB Forms JS                               * *-->
