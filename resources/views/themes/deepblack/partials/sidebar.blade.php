...
{{--       </li>--}}
        <li class="{{menuActive(['user.invest-history'])}}">
          <a href="{{route('user.invest-history')}}" class="sidebar-link">
             <img src="{{asset($themeTrue.'img/icon/growth-graph.png')}}" alt="@lang('invest ')"/>@lang('invest')
          </a>
        </li>
...
{{--            </a>--}}
{{--        </li>--}}
        <li class="{{menuActive(['user.payout.history','user.payout.history.search', 'user.payout.preview'])}}">
            <a href="{{route('user.payout.history')}}" class="sidebar-link">
                <img src="{{asset($themeTrue.'img/icon/payout.png')}}" alt="@lang('Withdraw')"/>@lang('Withdraw')
            </a>
        </li>
