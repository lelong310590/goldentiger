                        ...
                        <div class="card text-center bg-dark py-2">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group mx-auto text-center">
                                    <a href="javascript:void(0)" class="btn btn-bg btn-lg golden-text"
                ...
                <div class="col-lg-6 col-md-6 mb-3">
                    <div class="card text-center bg-dark py-2">
                        ...
                        <div class="card-body">
                            ...
                            <a class="btn btn btn-bg btn-md mt-3 golden-text"
            ...
            <div class="modal-content form-block">
                ...
                <form action="{{route('user.twoStepEnable')}}" method="POST">
                    ...
                    <div class="modal-footer border-top-0">
                        <button type="submit" class="btn btn-bg gold-btn">@lang('Verify')</button>
                    </div>
                </form>
            </div>
        </div>
            ...
            <div class="modal-content form-block">
                ...
                <form action="{{route('user.twoStepDisable')}}" method="POST">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-success gold-btn">@lang('Verify')</button>
                    </div>
                </form>
            </div>
